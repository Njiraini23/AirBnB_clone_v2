#!/usr/bin/python3
""" A python script that distributes the archive files on the web servers """
...
def do_pack()
"""
source a .tgz archive in the web_static directory
"""
...
def do_deploy(archive_path):
    """A script that distributes to the web servers"""
